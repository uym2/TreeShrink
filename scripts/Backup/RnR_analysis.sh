...
java -jar $treecmp -r ../species_trees/$d.astral.tre -i ../gene_trees/rogueNarok/$d.RnR.$m.trees -o ../results/$d.RnR.$m.MS.dat -P -d ms

compareTrees.missingBranch ../species_trees/$d.astral.tre ../gene_trees/rogueNarok/$d.RnR.$m.trees -simplify > ../results/$d.RnR.$m.RF.dat
