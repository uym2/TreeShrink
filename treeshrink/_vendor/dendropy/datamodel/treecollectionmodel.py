...
from treeshrink._vendor.dendropy.calculate import statistics
from treeshrink._vendor.dendropy.datamodel import basemodel
from treeshrink._vendor.dendropy.datamodel import taxonmodel
from treeshrink._vendor.dendropy.datamodel import treemodel
...
class TreeList(
    ...
    def __init__(self, *args, **kwargs):
        ...
        following ways::
            ...
            from treeshrink._vendor.dendropy import TaxonNamespace, Tree, TreeList
...
class SplitDistribution(taxonmodel.TaxonNamespaceAssociated):
    ...
    def _get_taxon_set(self):
        from treeshrink._vendor.dendropy import taxonmodel
