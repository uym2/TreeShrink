...
import copy
import sys
from treeshrink._vendor.dendropy.utility import GLOBAL_RNG
from treeshrink._vendor.dendropy.utility import container
from treeshrink._vendor.dendropy.utility import terminal
from treeshrink._vendor.dendropy.utility import error
from treeshrink._vendor.dendropy.utility import bitprocessing
from treeshrink._vendor.dendropy.utility import deprecate
from treeshrink._vendor.dendropy.utility import constants
from treeshrink._vendor.dendropy.utility import textprocessing
from treeshrink._vendor.dendropy.datamodel import basemodel
from treeshrink._vendor.dendropy.datamodel import taxonmodel
from treeshrink._vendor.dendropy import dataio
...
class Tree(
    ...
    def __init__(self, *args, **kwargs):
        ...
        Tree objects can be instantiated in the following ways::
            ...
            from treeshrink._vendor.dendropy import Tree, TaxonNamespace
    ...
    def node_distance_matrix(self):
        from treeshrink._vendor.dendropy.calculate.phylogeneticdistance import NodeDistanceMatrix
    ...
    def B1(self):
        ...
        deprecate.dendropy_deprecation_warning(
                ...
                new_construct="from treeshrink._vendor.dendropy.calculate import treemeasure\ntreemeasure.B1(tree)")
        from treeshrink._vendor.dendropy.calculate import treemeasure
    ...
    def find_missing_splits(self, other_tree):
        ...
        deprecate.dendropy_deprecation_warning(
                ...
                new_construct="from treeshrink._vendor.dendropy.calculate import treecompare\ntreecompare.find_missing_bipartitions(tree1, tree2)")
        from treeshrink._vendor.dendropy.calculate import treecompare
