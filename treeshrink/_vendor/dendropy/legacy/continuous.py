...
from treeshrink._vendor.dendropy.model import continuous
...
def simulate_continuous(node, rng=None, **kwargs):
    deprecate.dendropy_deprecation_warning(
            ...
            old_construct="from treeshrink._vendor.dendropy import continuous\ncontinuous.simulate_continuous(...)",
            new_construct="from treeshrink._vendor.dendropy.model import continuous\ncontinuous.evolve_continuous_char(...)",
