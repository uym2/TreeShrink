...
from treeshrink._vendor.dendropy.calculate import popgenstat
...
def num_segregating_sites(char_matrix, ignore_uncertain=True):
    deprecate.dendropy_deprecation_warning(
            ...
            old_construct="from treeshrink._vendor.dendropy import popgenstat\npopgenstat.num_segregating_sites(...)",
            new_construct="from treeshrink._vendor.dendropy.calculate import popgenstat\npopgenstat.num_segregating_sites(...)",
            )
