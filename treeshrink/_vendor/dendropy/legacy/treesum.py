...
from treeshrink._vendor.dendropy.calculate import treesum
...
class TreeSummarizer(treesum.TreeSummarizer):
    def __init__(self, **kwargs):
        deprecate.dendropy_deprecation_warning(
                ...
                old_construct="from treeshrink._vendor.dendropy import treesum\nm = treesum.TreeSummarizer(...)",
                new_construct="from treeshrink._vendor.dendropy.calculate import treesum\nm = treesum.TreeSummarizer(...)")
