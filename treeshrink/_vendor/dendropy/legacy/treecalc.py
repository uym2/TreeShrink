...
from treeshrink._vendor.dendropy.calculate import treescore
...
class PhylogeneticDistanceMatrix(dendropy.PhylogeneticDistanceMatrix):
    def __init__(self, tree=None):
        deprecate.dendropy_deprecation_warning(
                ...
                old_construct="from treeshrink._vendor.dendropy import treecalc\npdm = treecalc.PhylogeneticDistanceMatrix(...)",
                new_construct="import treeshrink._vendor.dendropy as dendropy\npdm = dendropy.PhylogeneticDistanceMatrix(...)")
