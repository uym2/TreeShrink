...
from treeshrink._vendor.dendropy.simulate import charsim
...
def generate_hky_dataset(seq_len,
    ...
    deprecate.dendropy_deprecation_warning(
            ...
            old_construct="from treeshrink._vendor.dendropy import seqsim\ndataset = seqsim.generate_hky_dataset(...)",
...
def generate_hky_characters(seq_len,
    ...
    deprecate.dendropy_deprecation_warning(
            ...
            new_construct="from treeshrink._vendor.dendropy.simulate import charsim\nchar_matrix = charsim.hky85_chars(...)")
