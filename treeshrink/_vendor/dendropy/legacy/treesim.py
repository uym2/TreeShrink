...
from treeshrink._vendor.dendropy.simulate import treesim
from treeshrink._vendor.dendropy.simulate import popgensim
...
def pop_gen_tree(*args, **kwargs):
    deprecate.dendropy_deprecation_warning(
            ...
            old_construct="from treeshrink._vendor.dendropy import treesim\ntree = treesim.pop_gen_tree(...)",
            new_construct="from treeshrink._vendor.dendropy.simulate import popgensim\ntree = popgensim.pop_gen_tree(...)")
...
def birth_death(*args, **kwargs):
    deprecate.dendropy_deprecation_warning(
            ...
            new_construct="from treeshrink._vendor.dendropy.simulate import treesim\ntree = treesim.birth_death_tree(...)")
    return treesim.birth_death_tree(*args, **kwargs)

# from treeshrink._vendor.dendropy.model.birthdeath import discrete_birth_death_tree as discrete_birth_death
...
# from treeshrink._vendor.dendropy.model.birthdeath import uniform_pure_birth_tree as uniform_pure_birth
...
# from treeshrink._vendor.dendropy.model.coalescent import contained_coalescent_tree as contained_coalescent
...
# from treeshrink._vendor.dendropy.model.coalescent import pure_kingman_tree as pure_kingman
...
# from treeshrink._vendor.dendropy.model.coalescent import mean_kingman_tree as mean_kingman
...
# from treeshrink._vendor.dendropy.model.coalescent import constrained_kingman_tree as constrained_kingman
...
# from treeshrink._vendor.dendropy.model.treeshape import star_tree
